...
public class Ponto {  
	...
	private static double LIMITE_INF = Ponto.LIMITE_INF_DEFAULT;
	private static double LIMITE_SUP = Ponto.LIMITE_SUP_DEFAULT;
	...
	public static void setLIMITE_INF(double inferior) {
		Ponto.LIMITE_INF = inferior;
	}
	public static void setLIMITE_SUP(double superior) {
		Ponto.LIMITE_SUP = superior;
	}
