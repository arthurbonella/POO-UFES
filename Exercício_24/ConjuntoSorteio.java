...
public class ConjuntoSorteio implements Serializable{
	 ...
	 * @param num_sort quantidade de numeros sorteados
	 */
	public void insere(Data data, int quant, int limInf, int limSup, int num_sort) throws Exception {

		aux = new Sorteio(data.getDia(),data.getMes(),data.getAno(),quant,limInf,limSup);
